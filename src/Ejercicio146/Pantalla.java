...
public class Pantalla extends javax.swing.JFrame {
    ...
    double iteracionesASimular;
    double iteracionesAMostrar;
    ...
    private void initComponents() {
        ...
        labelErrorDias = new javax.swing.JLabel();
        labelErrorSumaLitros = new javax.swing.JLabel();
        ...
        txt_IteracionesAMostrar.setText("100");
        txt_IteracionesAMostrar.setToolTipText("Ingrese la cant. de dias a mostrar");
        txt_IteracionesAMostrar.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        txt_IteracionesAMostrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_IteracionesAMostrarActionPerformed(evt);
            }
        });
        ...
        txt_litrosA.setText("25");

        jLabel6.setText("Litros C");

        txt_litrosB.setText("20");

        jLabel7.setText("Litros A");

        txt_litrosC.setText("20");

        jLabel8.setText("Litros D");

        txt_litrosD.setText("25");
        ...
        jLabel15.setText("Litros Iniciales:");

        labelErrorDias.setForeground(new java.awt.Color(255, 51, 51));
        labelErrorDias.setToolTipText("");

        labelErrorSumaLitros.setForeground(new java.awt.Color(255, 51, 51));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txt_IteracionesAMostrar, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(txt_Iteraciones, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addComponent(labelErrorDias))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(labelErrorSumaLitros, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addGap(43, 43, 43)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(labelErrorDias, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addContainerGap()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(labelErrorSumaLitros))
                            .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void btn_SimularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SimularActionPerformed
        ...
        if ((litrosA + litrosB + litrosC + litrosD) > 90) {
            todoBien = false;
            labelErrorSumaLitros.setText("La suma total de los litros no puede ser mayor a 90!");
        }

        iteracionesASimular = Double.parseDouble(txt_Iteraciones.getText());
        iteracionesAMostrar = Double.parseDouble(txt_IteracionesAMostrar.getText());
        if (iteracionesAMostrar > iteracionesASimular) {
            todoBien = false;
            labelErrorDias.setText("Dias a Mostrar no puede ser superior que Dias a Simular!");
        }
        ...
        if (todoBien) {
            ...
            while (iteracion < iteracionesASimular) {
                ...
                // Se cargan los resultados de cada sucursal
                resultados.clear();
                resultados.add(resultadosA);
                resultados.add(resultadosB);
                resultados.add(resultadosC);
                resultados.add(resultadosD);

                // Se ordenan los resultados de las sucursales de mayor a menor
                resultados.sort(new Comparator<Float>() {
                    @Override
                ...
                // System.out.println("A: " + litrosA + "  B: " + litrosB + "  C: " + litrosC + "  D: " + litrosD);
                // Se actualizan los valores
                // El maximo
                if (resultados.get(0) == resultadosA) {
                    litrosA += PESO;
                } else if (resultados.get(0) == resultadosB) {
                    litrosB += PESO;
                } else if (resultados.get(0) == resultadosC) {
                    litrosC += PESO;
                } else if (resultados.get(0) == resultadosD) {
                    litrosD += PESO;
                }

                // el segundo
                if (resultados.get(1) == resultadosB) {
                    litrosB += PESO;
                } else if (resultados.get(1) == resultadosC) {
                    litrosC += PESO;
                } else if (resultados.get(1) == resultadosD) {
                    litrosD += PESO;
                } else if (resultados.get(1) == resultadosA) {
                    litrosA += PESO;
                }

                // El Tercero
                if (resultados.get(2) == resultadosC) {
                    litrosC -= PESO;
                } else if (resultados.get(2) == resultadosD) {
                    litrosD -= PESO;
                } else if (resultados.get(2) == resultadosA) {
                    litrosA -= PESO;
                } else if (resultados.get(2) == resultadosB) {
                    litrosB -= PESO;
                }

                // El cuarto
                if (resultados.get(3) == resultadosD) {
                    litrosD -= PESO;
                } else if (resultados.get(3) == resultadosA) {
                    litrosA -= PESO;
                } else if (resultados.get(3) == resultadosB) {
                    litrosB -= PESO;
                } else if (resultados.get(3) == resultadosC) {
                    litrosC -= PESO;
                }
    ...
    private void txt_IteracionesAMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_IteracionesAMostrarActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_IteracionesAMostrarActionPerformed
    ...
    private javax.swing.JLabel labelErrorDias;
    private javax.swing.JLabel labelErrorSumaLitros;
...
//        rndD = utils.getRnd();
    ...
    public void actualizarResultadoFinalEnPantalla() {
        ...
        String res = String.format("La ganancia máxima luego de %s dias es de $%s", String.valueOf(iteracion), String.valueOf(resultadoDiarioMaximo));
